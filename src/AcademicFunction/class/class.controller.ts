...
export class ClassController {
  ...
  @ApiResponse({
    ...
    schema: {
      example: {
        statusCode: 400,
        message: ['classname must be a string', 'classname must be at least 2 characters'],
        error: 'Bad Request',
      },
    },
  })
  ...
  @ApiResponse({
    ...
    schema: {
      example: {
        ...
        code: 'INVALID_TOKEN',
        timestamp: '2023-12-06T10:30:00.000Z',
        path: '/academic/class/507f1f77bcf86cd799439011',
      },
    },
  })
  @ApiResponse({
  ...
  @ApiResponse({
    status: HttpStatus.CONFLICT,
    description: 'Class cannot be deleted because it has associated batches',
    schema: {
      example: {
        statusCode: 409,
        message: 'Cannot delete class because it has associated batches',
        error: 'Conflict',
      },
    },
  })
  ...
  @Get(':id/status')
  @Roles(UserRole.SUPER_ADMIN, UserRole.USER_ADMIN)
  @ApiOperation({ summary: 'Get class status and statistics' })
  @ApiParam({
    name: 'id',
    description: 'Class ID',
    example: '507f1f77bcf86cd799439011',
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Class status and statistics',
    schema: {
      example: {
        class: {
          _id: '507f1f77bcf86cd799439011',
  ...
  @ApiResponse({
    ...
    schema: {
      example: {
        ...
        code: 'INVALID_TOKEN',
        timestamp: '2023-12-06T10:30:00.000Z',
        path: '/academic/class/507f1f77bcf86cd799439011/status',
      },
    },
  })
  @ApiResponse({
  ...
  async getClassStatus(@Param('id') id: string) {
    return this.classService.getClassStatus(id);
  }

  @Put(':id/toggle-active')
  @Roles(UserRole.SUPER_ADMIN, UserRole.USER_ADMIN)
  @ApiOperation({ summary: 'Toggle class active status' })
  @ApiParam({
    name: 'id',
    description: 'Class ID',
    example: '507f1f77bcf86cd799439011',
  ...
  @ApiResponse({
    ...
    schema: {
      example: {
        ...
        code: 'INVALID_TOKEN',
        timestamp: '2023-12-06T10:30:00.000Z',
        path: '/academic/class/507f1f77bcf86cd799439011/toggle-active',
      },
    },
  })
  @ApiResponse({
